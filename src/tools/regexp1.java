...
{ 
    ...
    {
      //String str = "based_literal \r\n";
        String str = "<dd> decimal_literal | based_literal \r\n";
        ...
        try {
            ...
            while(line != null) {
                if(line.matches(validLine)) {
                    ...
                    wstr = "void " + name + "(Node p) throws ParseException {\r\n";
                    wstr += "    AST" + name + " node = new AST" + name + "(p);\r\n";
                    wstr += "    openNodeScope(node);\r\n";
                    wstr += "    closeNodeScope(node);\r\n";
                    wstr += "}\r\n\r\n";
                    writer.write(wstr);
                }
                line = reader.readLine();
    ...
    static void test_astconstants(String[] args)
    {
        ...
        try {
            ...
            for(int i = 0; i < astArray.size(); i++)
            {
                ...
                String pl = "    static final int " + upper + " = " + i + ";\r\n";
                writer.write(pl);
            }
            writer.write("\r\n");
            writer.write("    static final String[] ASTNodeName = \r\n    {\r\n");
            for(int i = 0; i < astArray.size(); i++)
            {
    ...
    static void test_astnodes(String[] args)
    {
        ...
        try {
            ...
            for(int i = 0; i < nodes.size(); i++) {
                ...
                String wstr = "package src.parser.vhdl.astnodes;\r\n\r\n";
                
                wstr += "import parser.vhdl.ASTNode;\r\n\r\n";
    
                wstr += node.comment;
                wstr += "class " + name + " extends ASTNode {\r\n";
                wstr += "    public " + name + "(ASTNode p) {\r\n";
                wstr += "        super(p, AST" + name.toUpperCase() + ");\r\n";
                wstr += "        assert(node.getId() == AST" + name.toUpperCase() + ");\r\n";
                wstr += "    }\r\n\r\n";
                wstr += "    public String scString() {\r\n";
                wstr += "        String ret = \"\";\r\n";
                wstr += "        return ret;\r\n";
                wstr += "    }\r\n";
                wstr += "}\r\n";
